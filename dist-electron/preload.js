...
electron_1.contextBridge.exposeInMainWorld('electron', {
    ...
    extensionsPickZip: () => electron_1.ipcRenderer.invoke('extensions-pick-zip'),
    extensionsInstallZip: (zipFilePath) => electron_1.ipcRenderer.invoke('extensions-install-zip', zipFilePath),
});
